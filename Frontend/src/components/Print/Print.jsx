...
const Print = ({ property, photoAmount }) => {
  ...
  return (
    <table className="property-pdf" id="pdfItem">
      <thead>
        <tr>
            ...
            <div className="center-column">
              <div className="main-title-container">
                ...
                <div className="main-price-container">
                  ...
                  <p className="rooms">{property.room_amount} {property.room_amount === 1 ? "Anbiente" : "Ambientes"} + {Math.round(property?.parking_lot_amount)} Cocheras</p>
                </div>
              </div>
          ...
          <td colSpan={2}>
            <div className="content-wrapper">
              <div className="left-column">
                ...
                <div className="description-text" dangerouslySetInnerHTML={{ __html: property.description }} />
              </div>
