      ...
      <div className="terminos-container">
        ...
        <Container>
          <div className="text-wrapper">
            ...
            <h4 className="subtitle">1. Acceso al Sitio Web.</h4>
            <p className="text">
              1.1. El acceso y utilización del Sitio Web no exige la previa
              suscripción o registro del Usuario.
            </p>

            <h4 className="subtitle">1.2. Utilización del Sitio Web.</h4>
            <p className="text">
            ...
            <h4 className="subtitle">1.3. Contenido del Sitio Web.</h4>
            <p className="text">
            ...
            <h4 className="subtitle">1.4. Uso Permitido del Sitio.</h4>
            <p className="text">
            ...
            <h4 className="subtitle">1.5. Usos Prohibidos.</h4>
            <p className="text">
            ...
            <h4 className="subtitle">2. Datos Personales del Usuario.</h4>
            <p className="text">
            ...
            <h4 className="subtitle">3. Menores de Edad.</h4>
            <p className="text">
            ...
            <h4 className="subtitle">4. Responsabilidad del Usuario.</h4>
            <p className="text">
            ...
            <h4 className="subtitle">5. Exclusión de Garantías y de Responsabilidad.</h4>
            <p className="text">
            ...
            <h4 className="subtitle">8. Indemnización.</h4>
            <p className="text">
            ...
            <h4 className="subtitle">10. General.</h4>
            <p className="text">
            ...
            <h4 className="subtitle">11. Duración y Terminación.</h4>
            <p className="text">
            ...
            <h4 className="subtitle">12. LOCALIZACIÓN</h4>
            <p className="text">12.1. ARGENTINA.</p>
            <p className="text">
            ...
            <p className="text">12.1.2. El Sitio Web es www.belga.com.ar.</p>
            <p className="text">
